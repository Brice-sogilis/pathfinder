...
interface IGridStoreService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  deleteAllGrids: grpc.MethodDefinition<pb_grid_pb.deleteAllGridRequest, pb_grid_pb.BooleanResponse>;
}
...
export interface IGridStoreServer extends grpc.UntypedServiceImplementation {
  ...
  deleteAllGrids: grpc.handleUnaryCall<pb_grid_pb.deleteAllGridRequest, pb_grid_pb.BooleanResponse>;
}
...
export class GridStoreClient extends grpc.Client {
  ...
  deleteAllGrids(argument: pb_grid_pb.deleteAllGridRequest, callback: grpc.requestCallback<pb_grid_pb.BooleanResponse>): grpc.ClientUnaryCall;
  deleteAllGrids(argument: pb_grid_pb.deleteAllGridRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<pb_grid_pb.BooleanResponse>): grpc.ClientUnaryCall;
  deleteAllGrids(argument: pb_grid_pb.deleteAllGridRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<pb_grid_pb.BooleanResponse>): grpc.ClientUnaryCall;
}
